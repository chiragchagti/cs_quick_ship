...
namespace cs_quick_ship_authentication_server.Services
{
    public class AuthorizeResultService : IAuthorizeResultService
    {
        ...
        /// <summary>
        /// Authorizing client and creaing authorization code.
        /// </summary>
        ...
        /// <summary>
        /// Creating JWT token with claims
        /// </summary>
        ...
        public TokenResult generateJWTTokne(IEnumerable<string> scopes, string tokenType, Client client, string sub)
        {
            ...
            if (tokenType == Constants.TokenTypes.JWTAcceseccToken)
            {
                ...
                string? publicPrivateKey1 = _configuration["PublicPrivateKey"];
